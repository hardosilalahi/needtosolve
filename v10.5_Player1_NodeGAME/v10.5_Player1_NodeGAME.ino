...
//   http.begin("http://192.168.0.34:1880/pingpong/p1/post/jsondata");      //Specify request destination
...
//   http.begin("http://192.168.0.34:1880/pingpong/p2/get/json");
...
//    http.begin("http://192.168.43.171:1880/tictactoe/player_x/post/signal");
...
//  http.begin("http://192.168.43.171:1880/tictactoe/player_o/get/signal");
...
//  http.begin("http://192.168.43.171:1880/tictactoe/player_o/get/row");
...
//  http.begin("http://192.168.43.171:1880/tictactoe/player_o/get/column");
...
//  http.begin("http://192.168.43.171:1880/tictactoe/player_o/get/turn");
...
//            http.begin("http://192.168.43.171:1880/tictactoe/player_x/post/row");
...
//            http.begin("http://192.168.43.171:1880/tictactoe/player_x/post/column");
...
//            http.begin("http://192.168.43.171:1880/tictactoe/player_x/post/turn");
