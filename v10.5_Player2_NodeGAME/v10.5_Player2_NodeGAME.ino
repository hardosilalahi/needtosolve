 ...
 * NodeMCU ESP8266 IP Address for testarduino --> 192.168.43.171
...
//    const char* server = "192.168.43.171";
...
//   http.begin("http://192.168.0.34:1880/pingpong/p2/post/jsondata");      //Specify request destination
...
//   http.begin("http://192.168.0.34:1880/pingpong/p1/get/jsondata");
//      http.begin("http://192.168.43.171:1880/pingpong/p2/get/signal");
...
//    http.begin("http://192.168.43.171:1880/tictactoe/player_o/post/signal");
...
//  http.begin("http://192.168.43.171:1880/tictactoe/player_x/get/signal");
...
//  http.begin("http://192.168.43.171:1880/tictactoe/player_x/get/row");
...
//  http.begin("http://192.168.43.171:1880/tictactoe/player_x/get/column");
...
//  http.begin("http://192.168.43.171:1880/tictactoe/player_x/get/turn");
...
//            http.begin("http://192.168.43.171:1880/tictactoe/player_o/post/row");
...
//            http.begin("http://192.168.43.171:1880/tictactoe/player_o/post/column");
...
//            http.begin("http://192.168.43.171:1880/tictactoe/player_o/post/turn");
